...
const products = [
  {
    ...
    flavors: [
      ...
      { name: 'Vanilla', colorHex: '#F0E6C8', kcal: 122, inStock: true },
    ...
    ingredients: 'Whey Protein Isolate, Cocoa Powder (only in chocolate flavor), Natural and Artificial Flavors, Soy Lecithin, Sucralose.',
    rating: 4.8,
    reviewCount: 147,
    salesCount: 850,
    featured: true,
...
const seedDB = async () => {
  try {
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/macros-nutrition');
    ...
    // Create an Admin account for testing if none exists
    ...
    if (!adminExists) {
      ...
      console.log('Created admin account: admin@macros.in / admin12345');
    }
