...
const Switch = ({ checked, onChange, title = 'Toggle theme' }) => {
  return (
    <StyledWrapper>
      <label className="cosmic-toggle" title={title} aria-label={title}>
        <input className="toggle" type="checkbox" checked={checked} onChange={onChange} />
